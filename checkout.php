...
if(isset($_POST['order'])){
    ...
    if($cart_total == 0){
        ...
        while($cart_item = mysqli_fetch_assoc($cart_query)){
            ...
            mysqli_query($conn, "INSERT INTO `order_items`(order_id, product_name, product_price, quantity, total_price) VALUES('$order_id', '$product_name', '$product_price', '$quantity', '$total_price')") or die('query failed');
        }
